  ...
  return (
    <div style={{ maxWidth: '600px', margin: '50px auto', padding: '20px', background: '#111', color: '#fff', borderRadius: '8px' }}>
      ...
      <div style={{ marginTop: '30px', padding: '20px', background: '#222', borderRadius: '6px' }}>
        ...
        <p>You can now upload files, store backups, and manage your data securely.</p>
      </div>

      <button
        onClick={() => supabase.auth.signOut()}
        style={{ marginTop: '30px', padding: '10px 20px', background: '#e53e3e', color: '#fff', border: 'none', cursor: 'pointer', borderRadius: '4px' }}
      >
        Log Out
      </button>
    </div>
